...
ActiveRecord::Schema.define(version: 20150428134138) do
  ...
  create_table "newsitems", force: :cascade do |t|
    ...
    t.date     "date_from"
    t.date     "date_until"
    t.boolean  "show_on_office", limit: 1
    t.boolean  "show_on_home",   limit: 1
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "cached_slug",    limit: 255
  end
  ...
  create_table "newsletters", force: :cascade do |t|
    ...
    t.boolean  "creating_messages",          limit: 1,     default: false, null: false
    t.boolean  "messages_created",           limit: 1,     default: false, null: false
  ...
  create_table "petition_types", force: :cascade do |t|
    ...
    t.boolean  "require_person_born_at",                      limit: 1
    t.boolean  "require_person_birth_city",                   limit: 1
    t.boolean  "display_signature_person_citizen",            limit: 1
    t.boolean  "display_signature_full_address",              limit: 1
    t.boolean  "require_signature_full_address",              limit: 1
  ...
  create_table "petitions", force: :cascade do |t|
    ...
    t.boolean  "show_twitter",                     limit: 1
    t.boolean  "show_history",                     limit: 1
    t.boolean  "show_map",                         limit: 1
    ...
    t.boolean  "display_more_information",         limit: 1
    t.boolean  "display_signature_person_citizen", limit: 1,     default: false
    t.boolean  "display_signature_full_address",   limit: 1,     default: false
  ...
  create_table "progressions", force: :cascade do |t|
    ...
    t.boolean  "send_update_message", limit: 1,     default: true
